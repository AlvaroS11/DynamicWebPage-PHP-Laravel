                ...
                <div class="hidden fixed top-0 right-0 px-6 py-0 sm:block">
                    ...
                    @if(auth()->user()->administrator==1)
                       ...
                       <g fill="none" fill-rule="evenodd">
                        ...
                        <a href="{{ url('/admin/emails') }}" class="block text-sm leading-8 hover:bg-grey-300 focus:bg-blue-400 hover:text-white"
                       
                        >Review emails</a>

                        
                        <a href="{{ url('/admin/faq/edit') }}" class="block text-sm leading-8 hover:bg-grey-300 focus:bg-blue-400 hover:text-white"
        ...
        <footer class="bg-gray-100 border border-black border-opacity-5 rounded-xl text-center py-16 px-10 mt-16">
            ...
            <div class="mt-10">
                <div class="relative inline-block mx-auto lg:bg-gray-200 rounded-full">
                    <a href="/contact">
                    <button class="bg-blue-500 text-white uppercase font-semibold text-xs py-2 px-10 rounded-2xl hover:bg-blue-600"> Contact</button>
                </a>
