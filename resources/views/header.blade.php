            ...
            <div class="space-y-2 lg:space-y-0 lg:space-x-4 mt-8">
                ...
                <div class="relative lg:inline-flex items-center bg-gray-100 rounded-xl">
                    ...
                    <div x-data="{show: false}" @click.away="show = false">
                        ...
                        {{isset($current) ? $current->name : 'Categories'}}
                    ...
                    <div x-show="show" class = "py-2 absolute bg-gray-100 mt-2 rounded-xl w-full z-50">
                       ...
                       <a href="/categories/{{$category->slug}}" class="block text-sm leading-8 hover:bg-grey-300 focus:bg-blue-400 hover:text-white"
                        {{isset($current) && $current->is($category) ? 'bg-blue-500 text-white' : '' }}
                        >{{$category->name}}</a>
                       @endforeach     
                    </div>
                    </div>
